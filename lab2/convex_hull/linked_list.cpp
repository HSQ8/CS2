 ...
 *
 */
// this program is leading memory because the list destructor only deletes the head,
// where as there are actually multiple dynamically allocated node that needs to be 
// deallocated by iteratively searching through the linked list and deleting every 
// node on the way
